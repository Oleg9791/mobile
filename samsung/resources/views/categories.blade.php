                ...
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <form action="https://internet-shop.tmweb.ru/basket/add/1" method="POST">
                            ...
                            <input type="hidden" name="_token" value="YXv2dgGgmNoRgzUtSkcZELJDgrYi0E7p8SG19WHC"></form>
                        </p>
                    </div>
                </div>
            </div>
            ...
            <div class="col-sm-6 col-md-4">
                <div class="thumbnail">
                    ...
                    <div class="caption">
                        ...
                        <p>11980 ₽</p>
                        <p>
                        <form action="https://internet-shop.tmweb.ru/basket/add/12" method="POST">
                            <button type="submit" class="btn btn-primary" role="button">В корзину</button>
                            <a href="https://internet-shop.tmweb.ru/mobiles/samsung_j6"
                               class="btn btn-default"
                               role="button">Подробнее</a>
                            <input type="hidden" name="_token" value="YXv2dgGgmNoRgzUtSkcZELJDgrYi0E7p8SG19WHC"></form>
                        </p>
